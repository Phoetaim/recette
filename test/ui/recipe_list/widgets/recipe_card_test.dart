...
void main() {
  group('RecipeCard', () {
    testWidgets(
      'affiche le nom, le nombre de personnes, la préparation et la cuisson',
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          const MaterialApp(home: Scaffold(body: RecipeCard(recipe: recipe))),
        );
    ...
    testWidgets(
      'utilise les valeurs par défaut quand la recette est incomplète',
      (WidgetTester tester) async {
  ...
  group('IconRow', () {
    ...
    testWidgets(
      'affiche un label vide sans planter',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(body: IconRow(icon: Icons.group, label: '')),
          ),
        );
