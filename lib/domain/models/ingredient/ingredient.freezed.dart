...
mixin _$Ingredient {
 ...
 int? get id; String get name; IngredientType get type;
...
@useResult
$Res call({
 int? id, String name, IngredientType type
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  IngredientType type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  IngredientType type)  $default,) {final _that = this;
switch (_that) {
case _Ingredient():
return $default(_that.id,_that.name,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  IngredientType type)?  $default,) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
return $default(_that.id,_that.name,_that.type);case _:
  return null;
...
class _Ingredient implements Ingredient {
  const _Ingredient({this.id, required this.name, this.type = IngredientType.other});
  factory _Ingredient.fromJson(Map<String, dynamic> json) => _$IngredientFromJson(json);

@override final  int? id;
@override final  String name;
@override@JsonKey() final  IngredientType type;
