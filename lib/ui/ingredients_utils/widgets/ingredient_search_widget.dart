...
class IngredientSearch extends StatelessWidget {
  ...
  List<ListTile> _generateSuggestions(BuildContext context, SearchController controller) {
    IngredientSearchResult searchResult = viewModel.handleSearch(controller.text.toLowerCase());
    String unit = searchResult.unit.id == defaultIngredientUnit.id ? '' : searchResult.unit.name;
        ...
        title: Row(
          children: [
            ValueListenableBuilder(
              valueListenable: viewModel.updatedIngredient,
